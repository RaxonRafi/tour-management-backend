...
router.get("/google/callback", passport_1.default.authenticate("google", { failureRedirect: `${env_1.envVars.FRONTEND_URL}/login?error=There is an issue with your account!` }), auth_controller_1.AuthControllers.googleCallbackController);
